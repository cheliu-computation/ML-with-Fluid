...
# numpy.save('dataset', data)

# fig = pyplot.figure(figsize=(11,7),dpi=100)
# ax  = fig.gca(projection='3d')

ground_truth = numpy.load('dataset.npy')
data = numpy.load('enkf/predicted_data.npy')
data2 = numpy.load('no_enkf/predicted_data.npy')
print(ground_truth.shape)
u = data[3, :].reshape(50,50)
print(data.shape)
...
ax.plot_surface(X,Y,u_g[:],cmap=cm.viridis,rstride=1,cstride=1)
